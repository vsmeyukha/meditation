...
export function BreathingModeCard({
  ...
  return (
    <Card
      ...
      onClick={onClick}
      className={cn(
        "flex-shrink-0 w-20 cursor-pointer transition-all duration-300 shadow-lg opacity-60 backdrop-blur-sm border-0 hover:opacity-80",
        className,
      )}
    >
      <CardContent className="flex flex-col items-center justify-center py-4 px-3 gap-2">
        {icon}
        <div
