...
> = {
  default: {
    ...
    subtitle: "Почувствуй себя в настоящем",
    description:
  ...
  box: {
    title: "Box - квадратное дыхание",
    subtitle: "Примени технику военного спокойствия",
    description:
      "Эта техника использовалась спецназом ВМС США — знаменитыми морскими котиками — для сохранения фокуса в экстремальных ситуациях . Четкая структура дыхания успокаивает нервную систему и возвращает контроль, даже когда вокруг хаос.",
    image: "/breathe/box.png",
  },
  coherent: {
    title: "Резонансное дыхание",
    subtitle: "Баланс внутри",
    description:
      "Эта техника основана на исследованиях современных учёных-психофизиологов и стала одним из самых надёжных способов успокоить нервную систему. При дыхании в ритме примерно 5–6 вдохов в минуту сердце и дыхание начинают работать в унисон. Возникает состояние резонанса, когда организм входит в гармонию с самим собой.",
    image: "/breathe/coherent.png",
  },
  relax: {
    title: "Relax - расслабляющий ритм",
    subtitle: "Let it go - отпусти напряжение",
    description:
      "Короткий вдох, слегка длинный выдох — как вздох на вершине волны. Это не древнее учение и не rocket science, но работает как мгновенный переключатель: расслабляет мышцы, успокаивает мысли и помогает уйти от напряженной активности.",
    image: "/breathe/relax.png",
  },
  "478": {
    title: "4-7-8 — дыхание йогов",
    subtitle: "Древняя мудрость, адаптированная врачом",
    description:
      "Корни этой техники уходят в йогическую пранаяму, но популяризатор этого паттерна — доктор Эндрю Вейл, великий сторонник интегративной медицины. Он назвал 4-7-8 «транквилизатором тела»: дыхание, которое помогает заснуть, справиться с тревогой и заполнить тело умиротворением. Этот метод помогает снизить уровень стресса, улучшить сон и повысить общее самочувствие.",
