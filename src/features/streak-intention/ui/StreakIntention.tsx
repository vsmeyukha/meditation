...
import { storageKeys, readLocalStorage, writeLocalStorage, StreakState } from "@/shared/lib/storage";
...
export function StreakIntention() {
  ...
  const streak = readLocalStorage<StreakState>(storageKeys.streak, { streakDays: 0 });
  ...
  return (
    <div className="space-y-4">
      ...
      <Badge variant="secondary">{streak.streakDays} day{streak.streakDays === 1 ? "" : "s"}</Badge>
    </div>
  );
}
