...
const topics = [
  { slug: "anxiety", title: "Anxiety Relief", hint: "Soften the nervous system" },
  { slug: "apathy", title: "Apathy & Low Motivation", hint: "Gentle activation" },
  { slug: "sleep", title: "Sleep", hint: "Wind down and rest" },
  { slug: "focus", title: "Focus", hint: "Clear, steady attention" },
  { slug: "self-compassion", title: "Self-Compassion", hint: "Kindness inward" },
  ...
  return (
    <main className="min-h-svh bg-gradient-to-b from-zinc-50 to-white text-zinc-900">
      <section className="mx-auto max-w-5xl px-6 py-12 sm:py-16">
        <h1 className="mb-6 text-3xl font-semibold tracking-tight">Meditations by Topic</h1>
              ...
              <Card className="h-full transition hover:shadow-sm">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="secondary" className="hidden sm:inline-flex">{t.hint}</Badge>
                  </div>
                </CardHeader>
