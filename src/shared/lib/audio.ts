...
function ringBellTone(): void {
  try {
    ...
    const WebkitCtx: typeof AudioContext | undefined = (window as unknown as { webkitAudioContext?: typeof AudioContext }).webkitAudioContext
...
export function playLoop(name: Exclude<SoundName, "bell">, volume: number): HTMLAudioElement {
